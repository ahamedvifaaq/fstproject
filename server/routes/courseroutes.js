...
import { createCourse , addModule ,createLesson, getLesson, getLessonCourse, runCode,getAllCourses,getCourseModules,uploadAudio, deleteModule, deleteLesson, enrollCourse } from "../controllers/coursecontroller.js";
...
router.get("/lesson/:lessonId/course", protect, getLessonCourse);
